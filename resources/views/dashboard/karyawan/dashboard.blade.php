...
<div class="row">
	...
	<div class="col-sm-5">
		<div class="border border p-3">
			<form action="{{route('transaksi.tambahTransaksi')}}" method="POST" id="taransaksi">
				@csrf
				<button type="submit" id="transaksi" class="btn btn-block btn-outline-primary rounded p-3 ">
					<h4>
			...
			<div class="col-sm">
				<div class="bg-light border borderp p-3">
					<form action="{{route('pesanan.tambah')}}" method="POST" id="tambahPesanan">
						@csrf
					<button class="btn btn-outline-success p-3 btn-block" type="submit">
